...
const HomeStack = ()=>(
    <Stack.Navigator initialRouteName="Home" screenOptions={{ headerStyle:{backgroundColor: "#f7f7f7"}, headerTitleStyle:{color: colors.blood, fontSize: 24, fontWeight: "800"}, headerTintColor:colors.blood}}>
        <Stack.Screen name="Home" component={HomeScreen} options={{headerShown: true}}/>
        <Stack.Screen name="FindDonor" component={FindDonorScreen}/>
        <Stack.Screen name="BloodBank" component={BloodBanks} options={{headerTitle: "Blood Banks"}}/>
